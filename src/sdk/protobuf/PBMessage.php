<?php
namespace PHPGeTui\sdk\protobuf;

use PHPGeTui\sdk\igetui\ex\ActionChain;
use PHPGeTui\sdk\igetui\ex\ActionChain_Type;
use PHPGeTui\sdk\protobuf\encoding\base128varint;
use PHPGeTui\sdk\protobuf\type\PBBool;
use PHPGeTui\sdk\protobuf\type\PBInt;
use PHPGeTui\sdk\protobuf\type\PBString;
        ...
        //实例化不兼容
            switch ($this->fields[$index]){
                ...
                case 'ActionChain_Type':
                    $res = new ActionChain_Type();
                    break;
                default:
                    $res = new $this->fields[$index]();
            }
        return $this->values[$index][] = $res;
    }
        ...
        if (gettype($value) == 'object') {
            ...
            switch ($this->fields[$index]){
                ...
                case 'PBInt':
                    ...
                    break;
                case 'ActionChain_Type':
                    $this->values[$index] = new ActionChain_Type();
                    break;
                default:
